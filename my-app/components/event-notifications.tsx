            ...
            >
              ...
              <p className="mt-4 whitespace-pre-wrap break-words text-[14px] font-semibold leading-6">
                {displayedAnnouncementText}
                  ...
                  <AnnouncementReceipt key={currentAnnouncement.id} scope="event" id={currentAnnouncement.id} parentId={currentAnnouncement.event_id} userId={senderId} language={language} onConfirmed={() => setCurrentAnnouncement(null)} />
